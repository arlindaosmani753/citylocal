...
- [x] **PLAC-02**: GPS location is verified server-side at post time — user must be physically within proximity of the place
- [x] **PLAC-03**: User can upload at least one photo when creating a place post
- [x] **PLAC-04**: Each place has a dedicated detail page showing full info, photos, and ratings
...
- [x] **EVNT-02**: Events automatically hide from the feed after their end date/time passes
...
- [x] **EVNT-05**: Event detail page shows attendee count and RSVP list
...
| PLAC-02 | Phase 2 | Complete |
| PLAC-03 | Phase 2 | Complete |
| PLAC-04 | Phase 2 | Complete |
